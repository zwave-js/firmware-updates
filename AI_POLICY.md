...
We support using AI tools, including large language models, as tools when
contributing to Z-Wave JS projects. However, you are responsible for any
contributions you submit, and we are responsible for any contributions we merge
and release. We hold a high bar for all contributions to our projects.
...
We do not mind if you use AI tools to help you write. However, do not have tools
...
must be in a quote block, for example by using `>`, and disclosed as such. It
must be accompanied by your own commentary explaining the relevance and
...
Some Z-Wave JS projects use AI tools to assist with code reviews, issue triage,
...
may result in being blocked from contributing to Z-Wave JS projects. If you
believe your contribution was closed in error, you are welcome to reach out to a
...
published by the Open Home Foundation.
